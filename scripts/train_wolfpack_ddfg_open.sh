...
env="wolfpack"
algo="ddfg"
exp="ddfg-wolfpack-open"
name="open_remove_add"
seed_min=1
seed_max=1
...
# 预训练模型路径 (载入 Run21 黄金底座)
model_dir="/root/SDDFG/scripts/results/wolfpack/ddfg/ddfg-wolfpack-remove-only/run21/models"
