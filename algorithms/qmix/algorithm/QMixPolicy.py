...
class QMixPolicy(RecurrentPolicy):
    ...
    def get_q_values(self, obs_batch, prev_action_batch, rnn_states,
                     action_batch=None, rnn_masks=None):
        """
        ...
        q_batch, new_rnn_states = self.q_network(
            input_batch, rnn_states, rnn_masks=rnn_masks
        )
    ...
    def get_actions(self, obs, prev_actions, rnn_states, available_actions=None, t_env=None, explore=False):
        ...
        #print(torch.sum(torch.max(q_values_out,dim=1)[0]))
