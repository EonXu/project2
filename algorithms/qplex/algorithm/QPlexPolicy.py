import numpy as np
import torch
from algorithms.qplex.algorithm.agent_q_function import AgentQFunction
...
class QPlexPolicy(RecurrentPolicy):
    def __init__(self, config, policy_config, train=True):
        ...
        self.unit_dim = policy_config["unit_dim"]
    ...
    def get_hidden(self, obs_batch, prev_action_batch, rnn_states, action_batch=None):
        """
